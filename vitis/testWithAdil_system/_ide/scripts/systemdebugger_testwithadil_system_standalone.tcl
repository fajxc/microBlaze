...
fpga -file C:/ENEL400/microBlaze/vitis/testWithAdil/_ide/bitstream/dwag.bit
targets -set -nocase -filter {name =~ "*Hart*#0"}
loadhw -hw C:/ENEL400/microBlaze/vitis/platform/export/platform/hw/dwag.xsa -regs
targets -set -nocase -filter {name =~ "*Hart*#0"}
rst -system
after 3000
targets -set -nocase -filter {name =~ "*Hart*#0"}
